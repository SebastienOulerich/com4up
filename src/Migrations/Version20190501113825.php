 ...
 */
final class Version20190501113825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, client VARCHAR(255) NOT NULL, date VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL, techno VARCHAR(255) NOT NULL, url_site VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
